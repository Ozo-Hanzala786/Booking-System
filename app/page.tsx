...
const FEATURED_PRODUCTS = [
  ...
  },
  {
    ...
    price: 1499,
    category: "Trousers",
    image: "https://images.unsplash.com/photo-1624378439575-d1ead6bb3d5c?q=80&w=1000&auto=format&fit=crop",
  },
  {
    id: "3",
          ...
          >
            ...
            >
              <div className="w-16 h-16 relative rounded-xl overflow-hidden">
                <Image src={FEATURED_PRODUCTS[0].image} alt="Product" fill className="object-cover" />
              </div>
              <div>
                <p className="text-xs text-gray-400 font-medium uppercase tracking-wider mb-1">Trending Now</p>
                <p className="font-bold text-accent">Vintage Graphic Tee</p>
              </div>
            </motion.div>
          </motion.div>
        </div>
